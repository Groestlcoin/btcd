...
5. [How do I use bootstrap.dat with grsd?](#Importing)
...
The bootstrap.dat file is made available from
[here](https://github.com/Groestlcoin/bootstrap).
...
### 5. How do I use bootstrap.dat with grsd?
...
**Windows:**
```bat
C:\> "%PROGRAMFILES%\Grsd Suite\grsd\addblock" -i C:\Path\To\bootstrap.dat
```
