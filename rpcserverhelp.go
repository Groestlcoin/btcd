...
var helpDescsEnUS = map[string]string{
	...
	"getblockchaininforesult-unifiedsoftforks":     "The status of the super-majority soft-forks used by groestlcoind on or after v2.19.0",
	...
	"unifiedsoftforks-softforks":        "The status of the super-majority soft-forks used by groestlcoind on or after v2.19.0",
	"unifiedsoftforks-softforks--key":   "softforks",
	"unifiedsoftforks-softforks--value": "An object describing an active softfork deployment used by groestlcoind on or after v2.19.0",
	"unifiedsoftforks-softforks--desc":  "JSON object describing an active softfork deployment used by groestlcoind on or after v2.19.0",
	...
	"sendrawtransaction-feesetting":   "Whether or not to allow insanely high fees in groestlcoind < v2.19.0 or the max fee rate for groestlcoind v2.19.0 and later (grsd does not yet implement this parameter, so it has no effect)",
	"sendrawtransaction--result0":     "The hash of the transaction",
	"allowhighfeesormaxfeerate-value": "Either the boolean value for the allowhighfees parameter in groestlcoind < v2.19.0 or the numerical value for the maxfeerate field in groestlcoind v2.19.0 and later",
